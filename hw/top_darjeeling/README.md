...
Large parts of Darjeeling's code is generated based on configuration and template files read by [topgen](../../util/topgen/README.md) and [ipgen](../../util/ipgen/README.md).
Please do not edit autogenerated code files directly.
Please see the documentation of topgen and ipgen as well as the [usage examples for Earlgrey](../top_earlgrey/README.md#how-to-generate) for how to work with the tooling as well as configuration and template files.
